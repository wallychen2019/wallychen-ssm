...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/employee/addRoleToUser.do" method="post">
				<!-- 正文区域 -->
		...
		<strong>Copyright &copy; 2014-2017<a href="http://www.tedu.cn">研究院研发部</a>.</strong> All rights reserved. </footer>
		<!-- 底部导航 /-->
	</div>

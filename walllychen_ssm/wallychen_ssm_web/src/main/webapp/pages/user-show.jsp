    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/employee/findAll.do">用户管理</a></li>
                    ...
                    <div class="table-box">
                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table"
                                ...
                                <tr data-tt-id="0">
                                    <td colspan="2">${employee.username}</td>
                                </tr>

                                <tbody>
                                <c:forEach items="${employee.roles}" var="role" varStatus="vs1">
